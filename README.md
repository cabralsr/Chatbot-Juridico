...
Para executar o projeto localmente, crie um arquivo `.env` na raiz e adicione a seguinte linha:

```env
GOOGLE_API_KEY="SUA_CHAVE_API"
```

> 🔐 **Importante:** Troque `"SUA_CHAVE_API"` pela chave gerada no [https://aistudio.google.com/api-keys](https://aistudio.google.com/api-keys)
